...
const SignIn = () => {
  ...
  return (
    <div className='w-full h-[100vh] bg-cover bg-center flex justify-center items-center' style={{ backgroundImage: `url(${bg})` }}>
      <form className='w-[90%] h-[600px] max-w-[500px] bg-[#00000069] backdrop-blur flex flex-col items-center justify-center gap-20px' onSubmit={handleSignIn}>
        <div className='mb-5'>
          <h1 className='text-white text-center text-4xl font-normal' style={{ fontFamily: "Roboto" }}> Welcome to </h1>
        ...
        <p className='text-gray-300 mt-4'>Want to creat an account ? <span onClick={() => navigate("/signup")} className='text-blue-400 underline cursor-pointer'>Sign Up</span></p>
      </form>
    </div>
  )
}
